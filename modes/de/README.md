# applyd — Deutsche Modi (`modes/de/`)

Dieser Ordner enthält die deutschen Übersetzungen der wichtigsten applyd-Modi für Bewerber:innen, die im DACH-Raum (Deutschland, Österreich, Schweiz) suchen oder mit deutschen Stellenanzeigen arbeiten.
...
applyd hat keinen "Sprach-Schalter" als Code-Flag. Stattdessen gibt es zwei Wege:
...
## Wartung (persönlicher Fork)

Wenn the candidate eine Übersetzung verbessern oder einen weiteren Modus eindeutschen will:
...
3. Behalte die strukturellen Elemente (Block A-G, Tabellen, Code-Blöcke, Tool-Anweisungen) exakt bei.
4. Teste mit einer echten deutschen Stellenanzeige (z. B. von Stepstone oder Xing), bevor die Änderung in `main` landet.
