# Geteilter Kontext -- applyd (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle applyd-Modi
     in der deutschen Variante. Bevor du applyd verwendest, MUSST du:
